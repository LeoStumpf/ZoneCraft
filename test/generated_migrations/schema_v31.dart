...
class AppSettings extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> hintsEnabled = GeneratedColumn<int>(
    'hints_enabled',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (hints_enabled IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  @override
  List<GeneratedColumn> get $columns => [
...
class UiHints extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  UiHints(this.attachedDatabase, [this._alias]);
  ...
  @override
  UiHints createAlias(String alias) {
    return UiHints(attachedDatabase, alias);
  }
...
class PoiSets extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> source = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'radius\'',
    defaultValue: const CustomExpression('\'radius\''),
  );
...
class OsmReports extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  OsmReports(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  OsmReports createAlias(String alias) {
    return OsmReports(attachedDatabase, alias);
  }
...
class DatabaseAtV31 extends GeneratedDatabase {
  ...
  late final UiHints uiHints = UiHints(this);
  ...
  late final OsmReports osmReports = OsmReports(this);
  @override
